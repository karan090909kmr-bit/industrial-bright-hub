...
export const categories: Category[] = [
  ...
  },
  {
    ...
    products: [
      ...
      { name: 'Neoprene Chemical Gloves', description: 'Versatile protection against acids, bases, alcohols, and petroleum-based chemicals.' },
      { name: 'PVC Chemical Gloves', description: 'Cost-effective protection for handling acids, caustics, and oil-based substances.' },
      { name: 'Butyl Rubber Gloves', description: 'Superior resistance to ketones, esters, and gas/vapor permeation for laboratory use.' },
