      ...
      <div className="relative container-custom mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-accent/20 text-accent px-4 py-2 rounded-full text-sm font-medium mb-6 animate-fade-up">Trusted Industrial Partner <span className="w-2 h-2 bg-accent rounded-full animate-pulse" />
              Trusted Industrial Partner Since 1995
            </div>
            
            <h1 style={{
            animationDelay: '0.1s'
          }} className="font-display text-4xl sm:text-5xl font-bold text-primary-foreground leading-tight mb-6 animate-fade-up lg:text-5xl">Industrial Consumables &
Customized Fabric Solutions<span className="block text-accent text-3xl">From safety consumables to precision-manufactured workwear.</span>
            </h1>
            
            <p className="text-lg text-primary-foreground/80 mb-8 max-w-xl mx-auto lg:mx-0 animate-fade-up" style={{
            animationDelay: '0.2s'
          }}>
            ...
            {/* Trust badges */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 animate-fade-up" style={{
            animationDelay: '0.4s'
          }}>
              {features.map((feature, index) => <div key={index} className="flex items-center gap-2 text-primary-foreground/80">
          ...
          {/* Visual element */}
          <div className="hidden lg:block relative animate-fade-up" style={{
          animationDelay: '0.3s'
        }}>
