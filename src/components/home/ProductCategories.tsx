  ...
  return <section className="section-padding bg-background">
      <div className="container-custom mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-6">Complete Range of SPARS</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {categories.map((category, index) => <Link key={category.id} to={`/products#${category.id}`} className="card-industrial group p-8 animate-fade-up" style={{
